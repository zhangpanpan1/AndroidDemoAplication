...
public class VignetteFilter implements ImageFilterInterface {
	private ImageData image = null; // Í¼Æ¬ÐÅÏ¢Àà
	...
	public ImageData imageProcess() {
		...
		int ratio = image.getWidth() > image.getHeight() ? image.getHeight() * 32768 / image.getWidth() : image
				.getWidth() * 32768 / image.getHeight();
		int r, g, b;
